...
<head>
    ...
    <style>
        /* Enhanced CSS for full attractiveness: Blue-white theme, animations, gradients */
        :root {
            --primary-blue: #1a56db;
        ...
        /* Navbar Enhancements: Make it always visible, no hiding on mobile, sticky top */
        .navbar {
        ...
        /* Login Section - Full Attractive Design with Animations */
        .login-container {
            min-height: 100vh;
            display: flex;
            align-items: center;
        ...
        /* Footer adjustments if needed (assuming simple footer) */
        footer {
...
<body>
    <?php
        include ("includes/before_login_nav.php");
    ?>
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="card-header">
                ...
                <h3>Secure Login</h3>
                <p class="mb-0 opacity-75">Welcome back to Lab Automation</p>
            </div>
            <div class="card-body">
    ...
    if (isset($_POST['login'])) {
        ...
        if ($run_login && mysqli_num_rows($run_login) == 0) {
            echo "<script>alert('Password and email not correct! Try again')</script>";
        } else {
            // Store the user ID in the session
            $_SESSION['user_id'] = $user_data['user_id'];

            echo "<script>window.open('index-after login.php','_self')</script>";
        }
    }
    ?>
